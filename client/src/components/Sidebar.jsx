...
const Sidebar = ({sidebarOpen, setSidebarOpen}) => {
  ...
  return (
    ...
    items-center max-sm:absolute top-0 bottom-0 z-20 ${sidebarOpen ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
      <div className='w-full'>
        ...
        <Link to='/create-post' className='inline-flex items-center justify-center gap-2 px-4 py-2 mt-6 mx-6 
